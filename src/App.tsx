    ...
    <>
      ...
      <NavigationContainer>
        <Stack.Navigator headerMode={'screen'}>
          ...
          <Stack.Screen name='Pokemon' component={PokemonScreen} options={{ headerStatusBarHeight: 10, }} />
          <Stack.Screen name='Favorites' component={FavoritesScreen} options={{ headerStatusBarHeight: 10, }} />
        </Stack.Navigator>
      </NavigationContainer>
    </>
  );
